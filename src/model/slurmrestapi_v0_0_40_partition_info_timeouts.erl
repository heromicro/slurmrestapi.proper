...
-export([slurmrestapi_v0_0_40_partition_info_timeouts/0]).

-export([slurmrestapi_v0_0_40_partition_info_timeouts/1]).
...
slurmrestapi_v0_0_40_partition_info_timeouts() ->
    slurmrestapi_v0_0_40_partition_info_timeouts([]).

slurmrestapi_v0_0_40_partition_info_timeouts(Fields) ->
  Default = [ {'resume', slurmrestapi_v0_0_40_uint16_no_val:slurmrestapi_v0_0_40_uint16_no_val() }
            , {'suspend', slurmrestapi_v0_0_40_uint16_no_val:slurmrestapi_v0_0_40_uint16_no_val() }
            ],
