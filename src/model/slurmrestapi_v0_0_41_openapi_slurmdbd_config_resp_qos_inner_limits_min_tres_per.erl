...
-export([slurmrestapi_v0_0_41_openapi_slurmdbd_config_resp_qos_inner_limits_min_tres_per/0]).

-export([slurmrestapi_v0_0_41_openapi_slurmdbd_config_resp_qos_inner_limits_min_tres_per/1]).
...
slurmrestapi_v0_0_41_openapi_slurmdbd_config_resp_qos_inner_limits_min_tres_per() ->
    slurmrestapi_v0_0_41_openapi_slurmdbd_config_resp_qos_inner_limits_min_tres_per([]).

slurmrestapi_v0_0_41_openapi_slurmdbd_config_resp_qos_inner_limits_min_tres_per(Fields) ->
