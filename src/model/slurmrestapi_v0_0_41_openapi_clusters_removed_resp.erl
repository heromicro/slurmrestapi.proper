...
-export([slurmrestapi_v0_0_41_openapi_clusters_removed_resp/0]).

-export([slurmrestapi_v0_0_41_openapi_clusters_removed_resp/1]).

-export_type([slurmrestapi_v0_0_41_openapi_clusters_removed_resp/0]).

-type slurmrestapi_v0_0_41_openapi_clusters_removed_resp() ::
  [ {'deleted_clusters', list(binary()) }
...
slurmrestapi_v0_0_41_openapi_clusters_removed_resp() ->
    slurmrestapi_v0_0_41_openapi_clusters_removed_resp([]).

slurmrestapi_v0_0_41_openapi_clusters_removed_resp(Fields) ->
  Default = [ {'deleted_clusters', list(binary()) }
            , {'meta', slurmrestapi_v0_0_41_openapi_shares_resp_meta:slurmrestapi_v0_0_41_openapi_shares_resp_meta() }
            , {'errors', list(slurmrestapi_v0_0_41_openapi_shares_resp_errors_inner:slurmrestapi_v0_0_41_openapi_shares_resp_errors_inner()) }
            , {'warnings', list(slurmrestapi_v0_0_41_openapi_shares_resp_warnings_inner:slurmrestapi_v0_0_41_openapi_shares_resp_warnings_inner()) }
            ],
