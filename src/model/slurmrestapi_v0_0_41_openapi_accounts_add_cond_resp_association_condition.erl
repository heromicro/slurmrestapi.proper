...
-export([slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp_association_condition/0]).

-export([slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp_association_condition/1]).
...
slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp_association_condition() ->
    slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp_association_condition([]).

slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp_association_condition(Fields) ->
