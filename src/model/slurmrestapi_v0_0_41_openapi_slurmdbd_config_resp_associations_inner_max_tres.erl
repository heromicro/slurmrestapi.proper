...
-export([slurmrestapi_v0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres/0]).

-export([slurmrestapi_v0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres/1]).
...
slurmrestapi_v0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres() ->
    slurmrestapi_v0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres([]).

slurmrestapi_v0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres(Fields) ->
