...
-export([slurmrestapi_v0_0_39_qos_limits_max_active_jobs/0]).

-export([slurmrestapi_v0_0_39_qos_limits_max_active_jobs/1]).
...
slurmrestapi_v0_0_39_qos_limits_max_active_jobs() ->
    slurmrestapi_v0_0_39_qos_limits_max_active_jobs([]).

slurmrestapi_v0_0_39_qos_limits_max_active_jobs(Fields) ->
  Default = [ {'accruing', slurmrestapi_v0_0_39_uint32_no_val:slurmrestapi_v0_0_39_uint32_no_val() }
            , {'count', slurmrestapi_v0_0_39_uint32_no_val:slurmrestapi_v0_0_39_uint32_no_val() }
            ],
