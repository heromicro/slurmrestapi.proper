...
-export([slurmrestapi_v0_0_41_openapi_shares_resp_shares_shares_inner_tres_run_seconds_inner/0]).

-export([slurmrestapi_v0_0_41_openapi_shares_resp_shares_shares_inner_tres_run_seconds_inner/1]).
...
slurmrestapi_v0_0_41_openapi_shares_resp_shares_shares_inner_tres_run_seconds_inner() ->
    slurmrestapi_v0_0_41_openapi_shares_resp_shares_shares_inner_tres_run_seconds_inner([]).

slurmrestapi_v0_0_41_openapi_shares_resp_shares_shares_inner_tres_run_seconds_inner(Fields) ->
  Default = [ {'name', binary() }
            , {'value', slurmrestapi_v0_0_41_openapi_shares_resp_shares_shares_inner_tres_run_seconds_inner_value:slurmrestapi_v0_0_41_openapi_shares_resp_shares_shares_inner_tres_run_seconds_inner_value() }
            ],
