...
-export([slurmrestapi_v0_0_39_partition_info/0]).

-export([slurmrestapi_v0_0_39_partition_info/1]).
...
slurmrestapi_v0_0_39_partition_info() ->
    slurmrestapi_v0_0_39_partition_info([]).

slurmrestapi_v0_0_39_partition_info(Fields) ->
  Default = [ {'nodes', slurmrestapi_v0_0_39_partition_info_nodes:slurmrestapi_v0_0_39_partition_info_nodes() }
            , {'accounts', slurmrestapi_v0_0_39_partition_info_accounts:slurmrestapi_v0_0_39_partition_info_accounts() }
            , {'groups', slurmrestapi_v0_0_39_partition_info_groups:slurmrestapi_v0_0_39_partition_info_groups() }
            , {'qos', slurmrestapi_v0_0_39_partition_info_qos:slurmrestapi_v0_0_39_partition_info_qos() }
            , {'alternate', binary() }
