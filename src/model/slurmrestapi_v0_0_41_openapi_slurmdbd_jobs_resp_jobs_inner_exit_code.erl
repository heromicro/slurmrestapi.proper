...
-export([slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_exit_code/0]).

-export([slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_exit_code/1]).
...
slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_exit_code() ->
    slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_exit_code([]).

slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_exit_code(Fields) ->
