...
-export([slurmrestapi_v0_0_40_openapi_wckey_removed_resp/0]).

-export([slurmrestapi_v0_0_40_openapi_wckey_removed_resp/1]).
...
slurmrestapi_v0_0_40_openapi_wckey_removed_resp() ->
    slurmrestapi_v0_0_40_openapi_wckey_removed_resp([]).

slurmrestapi_v0_0_40_openapi_wckey_removed_resp(Fields) ->
