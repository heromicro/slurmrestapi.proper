...
-export([slurmrestapi_v0_0_41_openapi_clusters_resp/0]).

-export([slurmrestapi_v0_0_41_openapi_clusters_resp/1]).
...
slurmrestapi_v0_0_41_openapi_clusters_resp() ->
    slurmrestapi_v0_0_41_openapi_clusters_resp([]).

slurmrestapi_v0_0_41_openapi_clusters_resp(Fields) ->
