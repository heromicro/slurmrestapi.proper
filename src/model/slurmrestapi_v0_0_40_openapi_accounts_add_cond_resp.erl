...
-export([slurmrestapi_v0_0_40_openapi_accounts_add_cond_resp/0]).

-export([slurmrestapi_v0_0_40_openapi_accounts_add_cond_resp/1]).
...
slurmrestapi_v0_0_40_openapi_accounts_add_cond_resp() ->
    slurmrestapi_v0_0_40_openapi_accounts_add_cond_resp([]).

slurmrestapi_v0_0_40_openapi_accounts_add_cond_resp(Fields) ->
  Default = [ {'association_condition', slurmrestapi_v0_0_40_accounts_add_cond:slurmrestapi_v0_0_40_accounts_add_cond() }
            , {'account', slurmrestapi_v0_0_40_account_short:slurmrestapi_v0_0_40_account_short() }
            , {'meta', slurmrestapi_v0_0_40_openapi_meta:slurmrestapi_v0_0_40_openapi_meta() }
            , {'errors', list(slurmrestapi_v0_0_40_openapi_error:slurmrestapi_v0_0_40_openapi_error()) }
            , {'warnings', list(slurmrestapi_v0_0_40_openapi_warning:slurmrestapi_v0_0_40_openapi_warning()) }
