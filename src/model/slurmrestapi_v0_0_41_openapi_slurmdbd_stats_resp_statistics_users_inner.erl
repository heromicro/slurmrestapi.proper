...
-export([slurmrestapi_v0_0_41_openapi_slurmdbd_stats_resp_statistics_users_inner/0]).

-export([slurmrestapi_v0_0_41_openapi_slurmdbd_stats_resp_statistics_users_inner/1]).
...
slurmrestapi_v0_0_41_openapi_slurmdbd_stats_resp_statistics_users_inner() ->
    slurmrestapi_v0_0_41_openapi_slurmdbd_stats_resp_statistics_users_inner([]).

slurmrestapi_v0_0_41_openapi_slurmdbd_stats_resp_statistics_users_inner(Fields) ->
  Default = [ {'user', binary() }
            , {'count', integer() }
            , {'time', slurmrestapi_v0_0_40_stats_rpc_time:slurmrestapi_v0_0_40_stats_rpc_time() }
            ],
