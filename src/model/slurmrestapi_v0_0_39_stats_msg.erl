...
-type slurmrestapi_v0_0_39_stats_msg() ::
  ...
  | {'bf_active', boolean() }
  | {'rpcs_by_message_type', list(slurmrestapi_v0_0_39_stats_msg_rpcs_by_type_inner:slurmrestapi_v0_0_39_stats_msg_rpcs_by_type_inner()) }
  | {'rpcs_by_user', list(slurmrestapi_v0_0_39_stats_msg_rpcs_by_user_inner:slurmrestapi_v0_0_39_stats_msg_rpcs_by_user_inner()) }
  ].
