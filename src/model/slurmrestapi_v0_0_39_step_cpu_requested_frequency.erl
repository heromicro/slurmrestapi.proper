...
-export([slurmrestapi_v0_0_39_step_cpu_requested_frequency/0]).

-export([slurmrestapi_v0_0_39_step_cpu_requested_frequency/1]).
...
slurmrestapi_v0_0_39_step_cpu_requested_frequency() ->
    slurmrestapi_v0_0_39_step_cpu_requested_frequency([]).

slurmrestapi_v0_0_39_step_cpu_requested_frequency(Fields) ->
  Default = [ {'min', slurmrestapi_v0_0_39_uint32_no_val:slurmrestapi_v0_0_39_uint32_no_val() }
            , {'max', slurmrestapi_v0_0_39_uint32_no_val:slurmrestapi_v0_0_39_uint32_no_val() }
            ],
