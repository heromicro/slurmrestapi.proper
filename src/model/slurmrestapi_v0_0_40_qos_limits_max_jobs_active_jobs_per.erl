...
-export([slurmrestapi_v0_0_40_qos_limits_max_jobs_active_jobs_per/0]).

-export([slurmrestapi_v0_0_40_qos_limits_max_jobs_active_jobs_per/1]).
...
slurmrestapi_v0_0_40_qos_limits_max_jobs_active_jobs_per() ->
    slurmrestapi_v0_0_40_qos_limits_max_jobs_active_jobs_per([]).

slurmrestapi_v0_0_40_qos_limits_max_jobs_active_jobs_per(Fields) ->
  Default = [ {'account', slurmrestapi_v0_0_40_uint32_no_val:slurmrestapi_v0_0_40_uint32_no_val() }
            , {'user', slurmrestapi_v0_0_40_uint32_no_val:slurmrestapi_v0_0_40_uint32_no_val() }
            ],
