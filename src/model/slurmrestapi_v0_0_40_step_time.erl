...
-export([slurmrestapi_v0_0_40_step_time/0]).

-export([slurmrestapi_v0_0_40_step_time/1]).
...
slurmrestapi_v0_0_40_step_time() ->
    slurmrestapi_v0_0_40_step_time([]).

slurmrestapi_v0_0_40_step_time(Fields) ->
  Default = [ {'elapsed', integer() }
            , {'end', slurmrestapi_v0_0_40_uint64_no_val:slurmrestapi_v0_0_40_uint64_no_val() }
            , {'start', slurmrestapi_v0_0_40_uint64_no_val:slurmrestapi_v0_0_40_uint64_no_val() }
            , {'suspended', integer() }
            , {'system', slurmrestapi_v0_0_40_step_time_system:slurmrestapi_v0_0_40_step_time_system() }
            , {'total', slurmrestapi_v0_0_40_step_time_total:slurmrestapi_v0_0_40_step_time_total() }
