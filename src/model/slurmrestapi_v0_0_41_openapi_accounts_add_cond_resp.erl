...
-export([slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp/0]).

-export([slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp/1]).
...
slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp() ->
    slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp([]).

slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp(Fields) ->
  Default = [ {'association_condition', slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp_association_condition:slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp_association_condition() }
            , {'account', slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp_account:slurmrestapi_v0_0_41_openapi_accounts_add_cond_resp_account() }
            , {'meta', slurmrestapi_v0_0_41_openapi_shares_resp_meta:slurmrestapi_v0_0_41_openapi_shares_resp_meta() }
            , {'errors', list(slurmrestapi_v0_0_41_openapi_shares_resp_errors_inner:slurmrestapi_v0_0_41_openapi_shares_resp_errors_inner()) }
            , {'warnings', list(slurmrestapi_v0_0_41_openapi_shares_resp_warnings_inner:slurmrestapi_v0_0_41_openapi_shares_resp_warnings_inner()) }
