...
-export([slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp/0]).

-export([slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp/1]).

-export_type([slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp/0]).

-type slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp() ::
  [ {'jobs', list(slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner:slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner()) }
...
slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp() ->
    slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp([]).

slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp(Fields) ->
  Default = [ {'jobs', list(slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner:slurmrestapi_v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner()) }
            , {'meta', slurmrestapi_v0_0_41_openapi_shares_resp_meta:slurmrestapi_v0_0_41_openapi_shares_resp_meta() }
            , {'errors', list(slurmrestapi_v0_0_41_openapi_shares_resp_errors_inner:slurmrestapi_v0_0_41_openapi_shares_resp_errors_inner()) }
            , {'warnings', list(slurmrestapi_v0_0_41_openapi_shares_resp_warnings_inner:slurmrestapi_v0_0_41_openapi_shares_resp_warnings_inner()) }
            ],
