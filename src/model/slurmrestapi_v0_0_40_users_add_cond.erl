...
-export([slurmrestapi_v0_0_40_users_add_cond/0]).

-export([slurmrestapi_v0_0_40_users_add_cond/1]).
...
slurmrestapi_v0_0_40_users_add_cond() ->
    slurmrestapi_v0_0_40_users_add_cond([]).

slurmrestapi_v0_0_40_users_add_cond(Fields) ->
